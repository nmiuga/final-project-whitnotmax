...
#ifndef FINAL_PROJECT_SWIFT_H
#define FINAL_PROJECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="final_project",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
@class CLHeading;
@interface LocationStore (SWIFT_EXTENSION(final_project)) <CLLocationManagerDelegate>
